//Generated:2022-05-24 18:17:44// 6-267
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    ...
    gdpr: window.ftImp4373896 && window.ftImp4373896.gdpr || '',
    gdpr_consent: window.ftImp4373896 && window.ftImp4373896.gdpr_consent || '',
    gdpr_pd: window.ftImp4373896 && window.ftImp4373896.gdpr_pd || '',
    us_privacy: window.ftImp4373896 && window.ftImp4373896.us_privacy || '',
    campaignID: '115749',
    cID: '116264',
    pID: '4373896',
    creativeID: '3559169',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115749&sid=18300&plc=4373896&num=&adid=&advid=&adsrv=29&btreg=4373896&btadsrv=flashtalking&crt=3559169&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: ["http://servedby.flashtalking.com/click/8/115749;4373896;3559169;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/ca/acrobat/free-trial-download.html?sdid=7RZ367W3&mv=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?212420677-4373896;3559169;',
    centreAd: false,
    width: 728,
    height: 90,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/437/4373896/3559169/image/3559169.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/115749;4373896;202;pixel;Verizon;VerizonFY20AcrobatRTRAcrobatSiteVisitorsCADSKBAN728x90/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref: "http://servedby.flashtalking.com/click/8/115749;4373896;3559169;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/ca/acrobat/free-trial-download.html?sdid=7RZ367W3&mv=display",
    divID: 'ftdiv4373896',
    ...
    append: !!(window.ftImp4373896 && parseInt(window.ftImp4373896.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4373896') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
...
(function(o) {
    ...
    o.frameID = 'ftframe4373896';
    o.file = 'http://cdn.flashtalking.com/116264/3559169/index.html';
    o.altImg = 'http://servedby.flashtalking.com/imp/8/115749;4373896;204;gif;Verizon;VerizonFY20AcrobatRTRAcrobatSiteVisitorsCADSKBAN728x90/?';
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4373896").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4373896").style.display = "none";
		    }
		});
	}
}(ft4373896));
...
(function(o) {
    o.addEventListener("obaEnd", function(){
        try {
            document.getElementById("ftAdChoices_4373896").style.zIndex = "99";
        } catch(e){
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115749&l2=Verizon&l3=4373896&l4=3559169&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115749&l2=Verizon&l3=4373896&l4=3559169&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_4373896;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_4373896;
